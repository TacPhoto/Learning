...
cMain::cMain() : wxMDIParentFrame(nullptr, wxID_ANY, wxT("Sprited"), wxPoint(20, 20), wxSize(800, 600))
{
	// Add menu bar
	...
	wxButton* b = new wxButton(m_ToolBar, 10100 + 16, "ALPHA", wxDefaultPosition, wxSize(40, 24), 0);
	b->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(cMain::OnSelectColour), nullptr, this);
	m_ToolBar->AddControl(b);
...
void cMain::OnMenuSave(wxCommandEvent& evt)
{
	...
	{
		wxFileDialog dlg(this, "Save File", "", "", ".spr Files (*.spr)|*.spr", wxFD_SAVE | wxFD_OVERWRITE_PROMPT);
		if (dlg.ShowModal() == wxID_OK)
		{
